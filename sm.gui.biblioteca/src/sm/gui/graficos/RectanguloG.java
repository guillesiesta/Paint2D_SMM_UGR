 ...
 * @author guillesiesta
 */
public class RectanguloG extends FiguraG{
    ...
    //por defecto
    public RectanguloG(){
       this.figura = new Rectangle2D.Double();
    ...
    //con parametros
    public RectanguloG(Color c, Stroke trazo, boolean transpa, boolean alisa, Composite co,
